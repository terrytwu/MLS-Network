...
for(i in unique(df$event_year))
{
  ...
  g<-ggplot(d1, aes(x=event_time,y=num))+
    ...
    geom_vline(xintercept = 0,size=2)
  # save
  Name<-paste("trans_diff_year_",i,"_pre2013.pdf",sep="")
...
for(i in unique(df$event_year))
{
  ...
  g<-ggplot(d1, aes(x=event_time,y=num))+
    ...
    geom_vline(xintercept = 0,size=2)
  # save
  Name<-paste("probs_diff_year_",i,"_pre2013.pdf",sep="")
  ggsave(g, file=Name,width = 25, height = 20, units = "cm")
  # print the process
  print(i)
}
...
# the following is for transaction mean and prob of sales analysis
# restricting to pre-2013 subsample
# with log(transactions) by dropping 0 transactions

# removing zero transactions and transform to log(trans)
trans<-trans[trans$Num_Transactions>0,]
# to logarithm
trans$Num_Transactions<-log(trans$Num_Transactions)
...
ggplot(df, aes(x=event_time,y=num,group=group,color=group))+
  geom_line(size=2)+
  theme_bw()+
  ylab("Mean Log Transaction Counts by Event Time")+
  xlab("Event Time")+
  theme(axis.title.x = element_text(size = 25),
        axis.title.y = element_text(size = 25))+
  theme(axis.text.x = element_text(angle = 90))+
...
for(i in unique(df$event_year))
{
  ...
  g<-ggplot(d1, aes(x=event_time,y=num))+
    ...
    geom_vline(xintercept = 0,size=2)
  # save
  Name<-paste("logtrans_diff_year_",i,"_pre2013.pdf",sep="")
  ggsave(g, file=Name,width = 25, height = 20, units = "cm")
  # print the process
  print(i)
}
...
# then in the following for log(trans+1)
trans$Num_Transactions<-exp(trans$Num_Transactions)
...
# take log(trans+1)
trans$Num_Transactions<-log(trans$Num_Transactions+1)
...
ggplot(df, aes(x=event_time,y=num,group=group,color=group))+
  geom_line(size=2)+
  theme_bw()+
  ylab("Mean Log(Transaction+1) Counts by Event Time")+
  xlab("Event Time")+
  theme(axis.title.x = element_text(size = 25),
        axis.title.y = element_text(size = 25))+
  theme(axis.text.x = element_text(angle = 90))+
...
ggplot(d1, aes(x=event_time,y=num))+
  geom_line(size=2)+
  theme_bw()+
  ylab("Mean Log(Transaction+1) Difference by Event Time")+
  xlab("Event Time")+
  theme(axis.title.x = element_text(size = 25),
        axis.title.y = element_text(size = 25))+
  theme(axis.text.x = element_text(angle = 90))+
...
for(i in unique(df$event_year))
{
  ...
  g<-ggplot(d1, aes(x=event_time,y=num))+
    ...
    geom_vline(xintercept = 0,size=2)
  # save
  Name<-paste("logtrans1_diff_year_",i,"_pre2013.pdf",sep="")
  ggsave(g, file=Name,width = 25, height = 20, units = "cm")
  # print the process
  print(i)
}
